...
const RANKINGS: { key: keyof Creative; label: string; asc?: boolean; fmt: (v: number) => string }[] = [
  { key: "cpa", label: "CPAランキング", asc: true, fmt: formatCurrency },
  { key: "ctr", label: "CTRランキング", fmt: formatPercent },
  { key: "cvr", label: "CVRランキング", fmt: formatPercent },
  { key: "cost", label: "Costランキング", fmt: formatCurrency },
];
